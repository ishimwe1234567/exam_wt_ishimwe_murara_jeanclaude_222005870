...
if(isset($_REQUEST['resource_id'])) {
    ...
    $stmt = $connection->prepare("DELETE FROM debtmanagementresources WHERE resource_id=?");
    $stmt->bind_param("i", $resource_id);
    ?>
    <!DOCTYPE html>
    <html>
    <head>
        <title>Delete Resource Record</title>
        <script>
    ...
    if ($stmt->execute()) {
        echo "Resource record deleted successfully.";
    } else {
        echo "Error deleting resource record: " . $stmt->error;
    }
    }
?>
</body>
